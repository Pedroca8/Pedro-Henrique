...
# 📖 Dia 1 — O Começo de Algo Que Eu Já Deveria Ter Feito

Hoje marquei o início do meu novo projeto: **meu portfólio**.  
Um simples repositório no GitHub, mas que para mim significa muito mais do que código.  
É quase uma **carta aberta** para quem quiser entender o que me move como desenvolvedor e como pessoa.

---

## 💭 Por que começar agora

Faz tempo que eu adio isso.  
Sempre tinha uma desculpa: **falta de tempo, de ideia, de confiança**.  
Hoje percebi que o verdadeiro atraso não estava no código — mas na **coragem de começar algo que me mostrasse de verdade**.

Passei o dia observando outros projetos, navegando por portfólios incríveis de desenvolvedores que pareciam ter descoberto uma forma de transformar **HTML, CSS e JavaScript em arte**.  
Aquilo me inspirou.  
Me lembrou que programar não é apenas lógica e sintaxe — **é expressão**.

---

## 🎨 O que eu quero construir

Talvez o que eu busque com esse projeto seja exatamente isso:  
**expressar quem eu sou como developer**, o que aprendi e o que ainda estou aprendendo.

Não quero que seja um projeto fácil.  
Quero sentir o desconforto de quem está crescendo, a frustração de quem erra o código dez vezes antes de acertar.  
Quero olhar para esse portfólio e ver nele uma versão mais honesta de mim — alguém que **usa a programação como espelho, não como escudo**.

---

## 🧩 O que vem de antes

Tenho alguns projetos antigos, códigos que marcaram o início da minha jornada.  
Mas esse aqui é diferente.  
Aqui, quero colocar tudo o que aprendi — e tudo o que ainda não aprendi.  
Quero que esse portfólio seja o **reflexo do meu processo**, e não apenas do meu resultado.

---

## 🤖 Sobre o uso de IA

Mesmo usando IA, quero que ela seja uma **parceira, não uma muleta**.  
Vou usá-la para tirar dúvidas, explorar caminhos e aprender de forma mais consciente.  
No fim, é isso que me move: **aprender**.  
Não para mostrar que sei, mas para descobrir até onde posso ir.

---

## 🌍 O que pode acontecer

Talvez ninguém veja esse projeto.  
Talvez alguém veja e se identifique.  
Talvez um recrutador olhe e pense:  
> “Esse cara tem algo diferente.”

Seja qual for o desfecho, o que importa é o percurso.  
Porque, no fundo, **esse portfólio não é só uma página bonita — é meu próprio documentário em forma de código.**
